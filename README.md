...
spread: Point spread bet; This bet requires a team to win or lose by a specific number of points, which is set by the sportsbook. For example, if the spread is +3 for Los Angeles Lakers in a game that Lakers vs Clippers, and you bet Lakers will win, it means that you are betting on the chance that Lakers will win the game by at least 
secondHalfTotal: 
